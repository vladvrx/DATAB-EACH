...
<html lang="en" class="no-js">
  <head>
    ...
    <meta name="application-name" content="Data B-each">
    <meta name="mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="description" content="Explore the islands, restore their systems, and complete quests as session pressure rises.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Data B-each">
    <meta property="og:description" content="Explore the islands, restore their systems, and complete quests as session pressure rises.">
    ...
    <title>Data B-each</title>
    <link rel="icon" href="./reference/favicon.ico" sizes="any">
    <link rel="icon" href="./reference/icons/favicon_dark.svg" type="image/svg+xml" media="(prefers-color-scheme: dark)">
    <link rel="icon" href="./reference/icons/favicon_light.svg" type="image/svg+xml" media="(prefers-color-scheme: light)">
    <link rel="apple-touch-icon" href="./reference/icons/icon_180.png">
    ...
    <link rel="stylesheet" href="./direct-port/styles/session-pressure.css">
  ...
  <body>
    <aside id="preloader" aria-live="polite">
      <img class="logo" src="./reference/assets/databeach-logo.png" alt="Data B-each">
    ...
    <script type="module">
      ...
      startGame().catch((error) => {
        console.error("Data B-each could not start", error);
